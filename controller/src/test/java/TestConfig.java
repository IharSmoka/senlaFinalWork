...
//        f.setDataBaseUrl("jdbc:mysql://localhost:3306/test_price_monitoring");
        return f;
    }
    ...
    public DataSource dataSource() {
        ...
        String urlWithTimeZone = "jdbc:mysql://localhost:3306/test_price_monitoring?serverTimezone="+ config().getTimeZone();
